return {
  ...
  -- create a function that will self-terminate
  -- {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>gC[", "<Plug>(git-conflict-prev-conflict)", desc = "Previous Conflict" },
      { "<leader>gC]", "<Plug>(git-conflict-next-conflict)", desc = "Next Conflict" },
